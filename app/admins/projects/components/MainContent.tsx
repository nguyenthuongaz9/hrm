        ...
        <div className="w-full h-full p-5 space-y-10 overflow-auto">
            ...
            {projects.length < 1 && (
                <div className='w-full flex items-center justify-center'>
                    <h3 className='text-xl font-medium text-zinc-600'>Chưa có dự án nào</h3>
                </div>
            )}
